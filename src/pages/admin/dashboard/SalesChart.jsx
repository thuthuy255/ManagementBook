        ...
        <Stack direction="row" alignItems="center" justifyContent="space-between">
          <Stack spacing={1.5}>
            <Typography variant="h6" color="secondary">
              Lợi nhuận 6 tháng gần nhất
            </Typography>
            <Typography variant="h4">{formatPrice(150000000000)}</Typography>
          </Stack>
          <FormControl component="fieldset">
            <FormGroup row>
              <FormControlLabel
                ...
                label="Thu nhập"
              />
              <FormControlLabel control={<Checkbox checked={cos} onChange={handleLegendChange} name="cos" />} label="Chi phí bán hàng" />
            </FormGroup>
          </FormControl>
        </Stack>
